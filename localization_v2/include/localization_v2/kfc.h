...
//
    ...
    KVector     Cut(int row, const KList<short>& lCol) const;
    KVector     Cut(const KList<short>& lRow, int col) const;
    KVector     Cut(int i,int nType) const;
...
protected:
   ...
   virtual void		OnUpdate(const KVector& vP){ }
...
{    
    ...
    //copy
    Create(plList._uiCapacity, plList._bOwnership, plList._bArray);
